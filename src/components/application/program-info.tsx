    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm md:text-base">
          ...
          motivated high school students to develop their research skills;
          however, anyone is welcome to apply. Although a completed research
          paper is not guaranteed as an outcome of the program it is likely that
          students will be able to write a 15-page paper.
        </p>
      </div>
      ...
      <div>
        <p className="text-sm md:text-base">
          ...
          and proposal writing. Parallel to the group workshops, students will
          start individual work with their mentors. The program will conclude
          with a symposium on research papers, in which students will present
          their work.
        </p>
      </div>
      ...
      <div>
        <p className="text-sm md:text-base font-medium">
          Deadline for the application: June 20th at 11:59 PM (UTC-5)
        </p>
      </div>
